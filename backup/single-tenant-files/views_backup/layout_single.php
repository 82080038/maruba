...
<head>
    ...
    <title><?= htmlspecialchars($title ?? ($_ENV['APP_NAME'] ?? getenv('APP_NAME') ?? 'Koperasi KSP LGJ')) ?></title>
...
<body>
        ...
        <div class="header-content">
            <div class="header-left">
                ...
                <a href="<?= route_url('dashboard') ?>" class="header-brand">
                    ...
                    <?= htmlspecialchars($_ENV['APP_NAME'] ?? getenv('APP_NAME') ?? 'KSP LGJ') ?>
                </a>
            </div>
    ...
    <script>
        ...
        // Set user role from PHP session
        window.userRole = '<?= htmlspecialchars($_SESSION['user']['role'] ?? 'guest') ?>';
        ...
        function loadMenuItems() {
            ...
            const active = document.querySelector('#sidenavMenu .menu-item.active');
            if (active) centerMenuItem(active);
        }
